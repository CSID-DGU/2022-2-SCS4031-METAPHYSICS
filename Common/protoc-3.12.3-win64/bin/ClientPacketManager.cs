...
class PacketManager
{
	...
	{		
		...
		_onRecv.Add((ushort)MsgId.SEnterScene, MakePacket<S_EnterScene>);
		_handler.Add((ushort)MsgId.SEnterScene, PacketHandler.S_EnterSceneHandler);		
		...
		_onRecv.Add((ushort)MsgId.SAddFriend, MakePacket<S_AddFriend>);
		_handler.Add((ushort)MsgId.SAddFriend, PacketHandler.S_AddFriendHandler);
	}
